  ...
  return (
    <div className="overflow-hidden bg-theme_bg text-[#E8E4DC] selection:bg-theme_green/40 selection:text-white font-sans h-screen flex w-full">
      ...
      <aside className="w-1/4 max-w-xs flex flex-col bg-theme_sidebar border-r border-white/5 shadow-xl z-20">
        ...
        <div className="p-4">
          {/* New Chat Button */}
          <button className="w-full flex items-center justify-center gap-2 px-3 py-3 bg-theme_green/80 hover:bg-theme_green text-[#1C1917] rounded-xl text-sm font-bold transition-all duration-300 shadow-sm active:scale-95 group">
